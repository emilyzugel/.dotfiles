...
# mkdir -p ~/.local/bin
# ln -s ~/.dotfiles/rofi/rofi-wifi-menu.sh ~/.local/bin/rofi-wifi-menu
# chmod +x ~/.dotfiles/rofi/rofi-wifi-menu.sh
# export PATH="$HOME/.local/bin:$PATH"
# source ~/.bashrc
# run with --> rofi-wifi-menu
#
# INSTALL ASIAN FONTS (VIEW ONLY)
# sudo pacman -S noto-fonts-cjk noto-fonts
# fc-cache -fv
# PAra funcionar tambem no terminal adicione na config do kitty:
# font_family      Noto Sans Mono CJK JP
# font_family      Noto Sans Mono CJK KR
# font_family      Noto Sans Mono CJK SC
# font_family      Noto Sans Mono CJK TC
# E tambem na config do sitema:
